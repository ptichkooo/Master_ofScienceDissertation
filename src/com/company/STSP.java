...
public class STSP {
    ...
    public STSP(){
        ...
        String file_path = "/Users/natalia/Desktop/Файлы/ВКР/Project/src/com/company/STSP/";
        ...
        if (directoryListing != null) {
            ...
            for (File child : directoryListing) {
                String current_path = file_path + child.getName();
                Parser parser = null;
                try {
                    parser = new Parser();
    ...
    public void get_result_STSP_LKH() {
    ...
    private void generateFileSTPSandPar(Parser parser) {
        String preorder_file = parser.name + "Preorder.tsp";
        //String par_file = parser.name+".par";
